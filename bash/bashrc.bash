...
# Work computer
if [ "blake-OptiPlex-755" = "$(uname -n)" ]
then
    prompt_color="$light_blue_prompt"
# Home Desktop (AMD)
elif [ "blake-ubuntu-desktop" = "$(uname -n)" ]
then
    prompt_color="$light_green_prompt"
# Home Destkop (Intel, fastest computer)
elif [ "blake-intel-desktop" = "$(uname -n)" ]
then
